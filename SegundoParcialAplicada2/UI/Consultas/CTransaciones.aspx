<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CTransaciones.aspx.cs" Inherits="SegundoParcialAplicada2.UI.Consultas.CTransaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card-header text-uppercase text-center">Consultar Transaciones</div>
    <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="form-row justify-content-center">
                    <asp:GridView ID="ConsultaGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                        ...
                        <Columns>
                            <asp:BoundField DataField="TransacionId" HeaderText="TransacionId" />
                            <asp:BoundField DataField="Fecha" HeaderText="Fecha" />
                            <asp:BoundField DataField="Tipo" HeaderText="Tipo" />
                            <asp:BoundField DataField="Monto" HeaderText="Balance" />
                        </Columns>
